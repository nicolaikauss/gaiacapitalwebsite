  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="relative z-10 flex h-full w-full flex-col items-center justify-center gap-3 text-white md:gap-4"
          style={{ color: "rgba(255, 255, 255, 1)", fontFamily: '"Noto Color Emoji"' }}
        >
          <h2
            ref={titleTopRef}
            aria-hidden
          ...
          <div
            ref={cardRef}
            className="relative overflow-hidden rounded-[12px] ring-1 ring-white/10 shadow-[0_20px_80px_rgba(0,0,0,0.55)] will-change-transform md:rounded-[16px]"
            style={{
